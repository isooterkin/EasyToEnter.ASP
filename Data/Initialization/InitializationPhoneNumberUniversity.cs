using Class = EasyToEnter.ASP.Models.Models.PhoneNumberUniversityModel;

namespace EasyToEnter.ASP.Data.Initialization
{
    public class InitializationPhoneNumberUniversity
    {
