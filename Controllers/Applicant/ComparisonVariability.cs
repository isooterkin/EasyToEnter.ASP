    ...
    public partial class ApplicantController
    {
        ...
        public async Task<IActionResult> ComparisonVariabilityAsync()
        {
            ...
            List<VariabilityFavoritesModel> variabilityFavoritesList = await _context.VariabilityFavorites
                ...
                .Include(vf => vf.VariabilityModel!.FocusUniversityModel!.UniversityModel!.Dormitorys!)
                .Include(vf => vf.VariabilityModel!.FocusUniversityModel!.UniversityModel!.AddressModel!.CityModel!.RegionModel)
                .Include(vf => vf.VariabilityModel!.FocusUniversityModel!.LevelFocusModel!.FocusModel!.AreaFocuss!)
