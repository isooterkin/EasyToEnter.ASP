...
namespace EasyToEnter.ASP.Controllers
{
    public class UniversityModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Abbreviation,EmailAddress,Address,MilitaryDepartment,CityId,AccreditationId,Description,Name,Id")] UniversityModel universityModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Abbreviation,EmailAddress,Address,MilitaryDepartment,CityId,AccreditationId,Description,Name,Id")] UniversityModel universityModel)
        {
