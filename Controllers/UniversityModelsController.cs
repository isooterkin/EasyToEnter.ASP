...
namespace EasyToEnter.ASP.Controllers
{
    public class UniversityModelsController : Controller
    {
        ...
        {
            var easyToEnterDbContext = _context.University.Include(u => u.AccreditationModel).Include(u => u.AddressModel);
        ...
        public async Task<IActionResult> Create([Bind("Abbreviation,EmailAddress,MilitaryDepartment,Website,AddressId,AccreditationId,Description,Name,Id")] UniversityModel universityModel)
        {
            ...
            ViewData["AddressId"] = new SelectList(_context.Address, "Id", "House", universityModel.AddressId);
            return View(universityModel);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Abbreviation,EmailAddress,MilitaryDepartment,Website,AddressId,AccreditationId,Description,Name,Id")] UniversityModel universityModel)
        {
