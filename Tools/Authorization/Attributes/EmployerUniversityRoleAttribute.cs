...
namespace EasyToEnter.ASP.Tools.Authorization.Attributes
{
    ...
    public class EmployerUniversityRoleAttribute : SessionCheckAttribute, IAuthorizationFilter
    {
        public new void OnAuthorization(AuthorizationFilterContext authorizationFilterContext)
        {
            ...
            if (SessionPerson.IsAuthenticated == true && SessionPerson.Person!.RoleId != 3)
