...
namespace EasyToEnter.ASP.Migrations
{
    ...
    [Migration("20220622113902_Npgsql-1.0.3")]
    partial class Npgsql103
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyToEnter.ASP.Models.Models.DormitoryModel", b =>
                {
                    ...
                    b.HasIndex("AddressId", "UniversityId", "Name")
                        .IsUnique();
            ...
            modelBuilder.Entity("EasyToEnter.ASP.Models.Models.VacancyFavoritesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("VacancyId", "PersonId")
                        .IsUnique();

                    b.ToTable("VacancyFavorites");
                });
            ...
            modelBuilder.Entity("EasyToEnter.ASP.Models.Models.PersonModel", b =>
                {
                    ...
                    b.Navigation("VacancyFavoritess");
